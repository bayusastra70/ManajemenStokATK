!(function ($) {
  ...
  $(".navbar-nav > li  a").each(function () {
    ...
    $(".companies-logo-slider").length &&
      $(".companies-logo-slider").slick({
        ...
        responsive: [
          ...
          { breakpoint: 480, settings: { arrows: !0, centerMode: !0, slidesToShow: 3 } },
        ],
      }),
    $(".companies-logo-slider-bubble").length &&
      $(".companies-logo-slider-bubble").slick({
        centerMode: !0,
        centerPadding: "0px",
        slidesToShow: 5,
        prevArrow: $(".prev"),
    ...
    $(".clientSliderTerbaru").length &&
      $(".clientSliderTerbaru").slick({ centerMode: !0, centerPadding: "0px", dots: !0, slidesToShow: 1, prevArrow: $(".prev_clientterbaru"), nextArrow: $(".next_clientterbaru"), autoplay: !0, autoplaySpeed: 6e3 }),
    ...
    $(".clientSliderMobile").length &&
      $(".clientSliderMobile").slick({ centerMode: !0, centerPadding: "0px", dots: true, slidesToShow: 1, prevArrow: $(".prev_clientmobile"), nextArrow: $(".next_clientmobile"), autoplay: !0, autoplaySpeed: 6e3 }),
    ...
    $(".portfolio_slider_baru").length &&
      $(".portfolio_slider_baru").slick({
        dots: !1,
        arrows: !0,
        prevArrow: $(".prev_case_baru"),
        nextArrow: $(".next_case_baru"),
        centerPadding: "10px",
        slidesToShow: 3,
        slidesToScroll: 1,
        autoplay: !1,
    ...
    $(".portfolio_slider_harga").length &&
      $(".portfolio_slider_harga").slick({
        dots: true,
        arrows: !0,
        prevArrow: $(".prev_case_harga"),
        nextArrow: $(".next_case_harga"),
        centerPadding: "0px",
        slidesToShow: 3,
        slidesToScroll: 1,
        autoplay: !1,
    ...
    $(".blog-slider-terbaru").length &&
      $(".blog-slider-terbaru").slick({ centerMode: !0, centerPadding: "0px", dots: true, slidesToShow: 1, prevArrow: $(".prev_blog_terbaru"), nextArrow: $(".next_blog_terbaru"), autoplay: !0, autoplaySpeed: 6e3 }),

      $(".blog-slider-untuk-blog").length &&
      $(".blog-slider-untuk-blog").slick({ centerMode: !0,
         centerPadding: "0px",
          dots: true, 
          slidesToShow: 4, 
          prevArrow: $(".prev_blog_terbaru-forblog"),
           nextArrow: $(".next_blog_terbaru-forblog"), 
           autoplay: !0,
            autoplaySpeed: 6e3,
            responsive: [
              { breakpoint: 1200, settings: { slidesToShow: 2 } },
            ...
            $(".slider-banner-logo").length &&
            $(".slider-banner-logo").slick({ centerMode: !0,
               centerPadding: "0px",
                dots: true, 
                slidesToShow: 1, 
  ...
  $(".theme-btn-one.mx-auto").click(function () {
    $(".theme-btn-one.mx-auto").hide();
  });
})(jQuery);

let i = document.querySelector(".dropdown-toggle");
i.addEventListener('click', () => {
    const t = document.querySelector(".dropdown-menu");
    t.classList.toggle("displaySaya");
});